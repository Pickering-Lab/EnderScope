# A page to gather EnderScope builds and variants
...
| - | - | - | Enderlights | [Arduino firmware](builds/Enderlights.ino)| Jerome Mutterer| Neopixels illumination device that can be driven with a custom set of serial commands |- |
